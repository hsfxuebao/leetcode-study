...
上一篇文章 [几道智力题](https://labuladong.github.io/algo/4/32/119/) 中讨论到一个有趣的「石头游戏」，通过题目的限制条件，这个游戏是先手必胜的。但是智力题终究是智力题，真正的算法问题肯定不会是投机取巧能搞定的。所以，本文就借石头游戏来讲讲「假设两个人都足够聪明，最后谁会获胜」这一类问题该如何用动态规划算法解决。
...
[![img](https://labuladong.github.io/algo/images/%e5%8d%9a%e5%bc%88%e9%97%ae%e9%a2%98/title.jpg)](https://labuladong.github.io/algo/images/博弈问题/title.jpg)
...
这个 `stoneGame` 函数怎么写呢？博弈问题的难点在于，两个人要轮流进行选择，而且都贼精明，应该如何编程表示这个过程呢？其实不难，还是按照 [动态规划核心框架](https://labuladong.github.io/algo/3/25/69/) 中强调多次的套路，首先明确 `dp` 数组的含义，然后只要找到「状态」和「选择」，一切就水到渠成了。
...
[![img](https://labuladong.github.io/algo/images/%e5%8d%9a%e5%bc%88%e9%97%ae%e9%a2%98/1.png)](https://labuladong.github.io/algo/images/博弈问题/1.png)
...
[![img](https://labuladong.github.io/algo/images/%e5%8d%9a%e5%bc%88%e9%97%ae%e9%a2%98/2.png)](https://labuladong.github.io/algo/images/博弈问题/2.png)

这里需要注意一点，我们发现 base case 是斜着的，而且我们推算 `dp[i][j]` 时需要用到 `dp[i+1][j]` 和 `dp[i][j-1]`：

[![img](https://labuladong.github.io/algo/images/%e5%8d%9a%e5%bc%88%e9%97%ae%e9%a2%98/3.png)](https://labuladong.github.io/algo/images/博弈问题/3.png)

根据前文 [动态规划答疑篇](https://labuladong.github.io/algo/3/25/71/) 判断 `dp` 数组遍历方向的原则，算法应该倒着遍历 `dp` 数组：
...
[![img](https://labuladong.github.io/algo/images/%e5%8d%9a%e5%bc%88%e9%97%ae%e9%a2%98/4.png)](https://labuladong.github.io/algo/images/博弈问题/4.png)
