...
鉴于前文 [二分搜索框架详解](https://labuladong.github.io/algo/2/20/29/) 的那首《二分搜索升天词》很受好评，并在民间广为流传，成为安睡助眠的一剂良方，今天在滑动窗口算法框架中，我再次编写一首小诗来歌颂滑动窗口算法的伟大（手动狗头）：

[![img](https://labuladong.github.io/algo/images/slidingwindow/poem.jpg)](https://labuladong.github.io/algo/images/slidingwindow/poem.jpg)

哈哈，我自己快把自己夸上天了，大家乐一乐就好，不要当真：）

关于双指针的快慢指针和左右指针的用法，可以参见前文 [双指针技巧汇总](https://labuladong.github.io/algo/2/20/23/)，本文就解决一类最难掌握的双指针技巧：滑动窗口技巧。总结出一套框架，可以保你闭着眼睛都能写出正确的解法。
...
为什么呢？简单说，字符串/数组中的每个元素都只会进入窗口一次，然后被移出窗口一次，不会说有某些元素多次进入和离开窗口，所以算法的时间复杂度就和字符串/数组的长度成正比。后文 [算法时空复杂度分析实用指南](https://labuladong.github.io/algo/1/16/) 有具体讲时间复杂度的估算，这里就不展开了。
...
[![img](https://labuladong.github.io/algo/images/slidingwindow/title1.png)](https://labuladong.github.io/algo/images/slidingwindow/title1.png)
...
[![img](https://labuladong.github.io/algo/images/slidingwindow/1.png)](https://labuladong.github.io/algo/images/slidingwindow/1.png)

增加 `right`，直到窗口 `[left, right)` 包含了 `T` 中所有字符：

[![img](https://labuladong.github.io/algo/images/slidingwindow/2.png)](https://labuladong.github.io/algo/images/slidingwindow/2.png)

现在开始增加 `left`，缩小窗口 `[left, right)`：

[![img](https://labuladong.github.io/algo/images/slidingwindow/3.png)](https://labuladong.github.io/algo/images/slidingwindow/3.png)

直到窗口中的字符串不再符合要求，`left` 不再继续移动：

[![img](https://labuladong.github.io/algo/images/slidingwindow/4.png)](https://labuladong.github.io/algo/images/slidingwindow/4.png)
...
[![img](https://labuladong.github.io/algo/images/slidingwindow/title2.png)](https://labuladong.github.io/algo/images/slidingwindow/title2.png)
...
[![img](https://labuladong.github.io/algo/images/slidingwindow/title3.png)](https://labuladong.github.io/algo/images/slidingwindow/title3.png)
...
[![img](https://labuladong.github.io/algo/images/slidingwindow/title4.png)](https://labuladong.github.io/algo/images/slidingwindow/title4.png)
