...
|                           LeetCode                           |                             力扣                             | 难度 |
| :----------------------------------------------------------: | :----------------------------------------------------------: | :--: |
| [355. Design Twitteropen in new window](https://leetcode.com/problems/design-twitter/) | [355. 设计推特open in new window](https://leetcode.cn/problems/design-twitter/) |  🟠   |

力扣第 355 「设计推特」不仅题目本身很有意思，而且把合并多个有序链表的算法和面向对象设计（OO design）结合起来了，很有实际意义，本文就带大家来看看这道题。

至于 Twitter 的什么功能跟算法有关系，等我们描述一下题目要求就知道了。

### [#](https://labuladong.github.io/algo/di-yi-zhan-da78c/shou-ba-sh-daeca/she-ji-pen-d3575/#一、题目及应用场景简介)一、题目及应用场景简介
...
### [#](https://labuladong.github.io/algo/di-yi-zhan-da78c/shou-ba-sh-daeca/she-ji-pen-d3575/#二、面向对象设计)二、面向对象设计
...
![img](https://labuladong.github.io/algo/images/%E8%AE%BE%E8%AE%A1Twitter/tweet.jpg)
...
![img](https://labuladong.github.io/algo/images/%E8%AE%BE%E8%AE%A1Twitter/user.jpg)
...
### [#](https://labuladong.github.io/algo/di-yi-zhan-da78c/shou-ba-sh-daeca/she-ji-pen-d3575/#三、算法设计)三、算法设计
...
![img](https://labuladong.github.io/algo/images/%E8%AE%BE%E8%AE%A1Twitter/merge.gif)

至此，这道一个极其简化的 Twitter 时间线功能就设计完毕了。

### [#](https://labuladong.github.io/algo/di-yi-zhan-da78c/shou-ba-sh-daeca/she-ji-pen-d3575/#四、最后总结)四、最后总结
...
![img](https://labuladong.github.io/algo/images/%E8%AE%BE%E8%AE%A1Twitter/design.png)

我们解决的问题应该只能算 Timeline Service 模块的一小部分，功能越多，系统的复杂性可能是指数级增长的。所以说合理的顶层设计十分重要，其作用是远超某一个算法的。Github 上有一个优秀的开源项目，专门收集了很多大型系统设计的案例和解析，而且有中文版本，上面这个图也出自该项目。对系统设计感兴趣的读者可以点击 [这里open in new window](https://github.com/donnemartin/system-design-primer) 查看。