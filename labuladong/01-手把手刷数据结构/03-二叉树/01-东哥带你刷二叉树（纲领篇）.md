...
公众号历史文章的整个脉络都是按照 [学习数据结构和算法的框架思维](https://labuladong.github.io/algo/1/2/) 提出的框架来构建的，其中着重强调了二叉树题目的重要性，所以把本文放在第一篇。
...
本文中会用题目来举例，但都是最最简单的题目，所以不用担心自己看不懂，我可以帮你从最简单的问题中提炼出所有二叉树题目的共性，并将二叉树中蕴含的思维进行升华，反手用到 [动态规划](https://labuladong.github.io/algo/3/25/69/)， [回溯算法](https://labuladong.github.io/algo/4/31/104/)， [分治算法](https://labuladong.github.io/algo/4/33/122/)， [图论算法](https://labuladong.github.io/algo/2/22/50/) 中去，这也是我一直强调框架思维的原因。希望你在学习了上述高级算法后，也能回头再来看看本文，会对它们有更深刻的认识。
...
[![img](https://labuladong.github.io/algo/images/%e4%ba%8c%e5%8f%89%e6%a0%91%e6%94%b6%e5%ae%98/1.jpeg)](https://labuladong.github.io/algo/images/二叉树收官/1.jpeg)
...
你也可以看到， [图论算法基础](https://labuladong.github.io/algo/2/22/50/) 把二叉树的遍历框架扩展到了图，并以遍历为基础实现了图论的各种经典算法，不过这是后话，本文就不多说了。

### 两种解题思路

前文 [我的算法学习心得](https://labuladong.github.io/algo/1/3/) 说过：

**二叉树题目的递归解法可以分两类思路，第一类是遍历一遍二叉树得出答案，第二类是通过分解问题计算出答案，这两类思路分别对应着 [回溯算法核心框架](https://labuladong.github.io/algo/4/31/104/) 和 [动态规划核心框架](https://labuladong.github.io/algo/3/25/69/)**。
...
[![img](https://labuladong.github.io/algo/images/%e4%ba%8c%e5%8f%89%e6%a0%91%e6%94%b6%e5%ae%98/tree.jpg)](https://labuladong.github.io/algo/images/二叉树收官/tree.jpg)
...
[![img](https://labuladong.github.io/algo/images/%e4%ba%8c%e5%8f%89%e6%a0%91%e6%94%b6%e5%ae%98/3.jpeg)](https://labuladong.github.io/algo/images/二叉树收官/3.jpeg)
...
[![img](https://labuladong.github.io/algo/images/%e4%ba%8c%e5%8f%89%e6%a0%91%e6%94%b6%e5%ae%98/plugin1.png)](https://labuladong.github.io/algo/images/二叉树收官/plugin1.png)
...
[![img](https://labuladong.github.io/algo/images/%e4%ba%8c%e5%8f%89%e6%a0%91%e6%94%b6%e5%ae%98/tree1.png)](https://labuladong.github.io/algo/images/二叉树收官/tree1.png)
...
[![img](https://labuladong.github.io/algo/images/%e4%ba%8c%e5%8f%89%e6%a0%91%e6%94%b6%e5%ae%98/plugin2.png)](https://labuladong.github.io/algo/images/二叉树收官/plugin2.png)
...
后文 [BFS 算法框架](https://labuladong.github.io/algo/4/31/110/) 就是从二叉树的层序遍历扩展出来的，常用于求无权图的**最短路径**问题。

当然这个框架还可以灵活修改，题目不需要记录层数（步数）时可以去掉上述框架中的 for 循环，比如后文 [Dijkstra 算法](https://labuladong.github.io/algo/2/22/56/) 中计算加权图的最短路径问题，详细探讨了 BFS 算法的扩展。
...
[![img](https://labuladong.github.io/algo/images/%e4%ba%8c%e5%8f%89%e6%a0%91%e6%94%b6%e5%ae%98/plugin4.png)](https://labuladong.github.io/algo/images/二叉树收官/plugin4.png)
...
关于层序遍历（以及其扩展出的 [BFS 算法框架](https://labuladong.github.io/algo/4/31/110/)），我在最后多说几句。
