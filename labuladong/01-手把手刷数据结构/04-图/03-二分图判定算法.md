...
> 本文有视频版： [二分图判定算法及应用](https://www.bilibili.com/video/BV18N4y1L7aa/)。建议关注我的 B 站账号，我会用视频领读的方式带大家学习那些稍有难度的算法技巧。

我之前写了好几篇图论相关的文章：

[图遍历算法](https://labuladong.github.io/algo/di-yi-zhan-da78c/shou-ba-sh-03a72/tu-lun-ji--d55b2/)

[名流问题](https://labuladong.github.io/algo/di-yi-zhan-da78c/shou-ba-sh-03a72/zhong-li-x-30e4f/)

[并查集算法计算连通分量](https://labuladong.github.io/algo/di-yi-zhan-da78c/shou-ba-sh-03a72/bing-cha-j-323f3/)

[环检测和拓扑排序](https://labuladong.github.io/algo/di-yi-zhan-da78c/shou-ba-sh-03a72/huan-jian--e36de/)

[Dijkstra 最短路径算法](https://labuladong.github.io/algo/di-yi-zhan-da78c/shou-ba-sh-03a72/dijkstra-s-6d0b2/)
...
[![img](https://labuladong.github.io/algo/images/ref.jpg)](https://labuladong.github.io/algo/images/ref.jpg)
...
[![img](https://labuladong.github.io/algo/images/%e4%ba%8c%e5%88%86%e5%9b%be/1.png)](https://labuladong.github.io/algo/images/二分图/1.png)

显然无法对节点着色使得每两个相邻节点的颜色都不相同，所以算法返回 false。

但如果输入 `graph = [[1,3],[0,2],[1,3],[0,2]]`，也就是这样一幅图：

[![img](https://labuladong.github.io/algo/images/%e4%ba%8c%e5%88%86%e5%9b%be/2.png)](https://labuladong.github.io/algo/images/二分图/2.png)
...
[![img](https://labuladong.github.io/algo/images/%e4%ba%8c%e5%88%86%e5%9b%be/title.png)](https://labuladong.github.io/algo/images/二分图/title.png)
