...
记得我之前在讲 [图论算法基础](https://labuladong.github.io/algo/di-yi-zhan-da78c/shou-ba-sh-03a72/tu-lun-ji--d55b2/) 时说图论相关的算法不会经常考，但最近被打脸了，因为一些读者和我反馈近期求职面试涉及很多图论相关的算法，可能是因为环境不好所以算法这块更卷了吧。

常见的图论算法我都已经写过了，这里按难度顺序列举一下：

1. [图论算法基础](https://labuladong.github.io/algo/di-yi-zhan-da78c/shou-ba-sh-03a72/tu-lun-ji--d55b2/)
2. [二分图判定算法及应用](https://labuladong.github.io/algo/di-yi-zhan-da78c/shou-ba-sh-03a72/er-fen-tu--73400/)
3. [环检测/拓扑排序算法及应用](https://labuladong.github.io/algo/di-yi-zhan-da78c/shou-ba-sh-03a72/huan-jian--e36de/)
4. 并查集算法及应用（本文）
5. [Kruskal 最小生成树算法及应用](https://labuladong.github.io/algo/di-yi-zhan-da78c/shou-ba-sh-03a72/kruskal-zu-e6b5b/)
6. [Prim 最小生成树算法及应用](https://labuladong.github.io/algo/di-yi-zhan-da78c/shou-ba-sh-03a72/prim-zui-x-0ef51/)
7. [Dijkstra 算法模板及应用](https://labuladong.github.io/algo/di-yi-zhan-da78c/shou-ba-sh-03a72/dijkstra-s-6d0b2/)
...
[![img](https://labuladong.github.io/algo/images/unionfind%e5%ba%94%e7%94%a8/2.jpg)](https://labuladong.github.io/algo/images/unionfind应用/2.jpg)
